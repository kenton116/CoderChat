...
var messages = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#message').get(0);
var input = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#input').get(0);
var username = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#username').attr('name');
var userCountValue = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#user-count').get(0);
var quizName = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#quiz-name').get(0);
var quizByUsername = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#quiz-by-username').get(0);
